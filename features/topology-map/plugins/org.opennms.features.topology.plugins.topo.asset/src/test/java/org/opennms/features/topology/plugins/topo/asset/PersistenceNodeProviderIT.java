...
public class PersistenceNodeProviderIT {
    ...
    public void setUp() {
        ...
        OnmsNode node2 = new NodeBuilder()
                ...
                .withAsset("address1","Address 1")
                .withAsset("address2","Address 2")
                .withAsset("building","Building")
                .withAsset("category","Category")
                .withAsset("department","Department")
                .withAsset("description","Description")
                .withAsset("circuitId","CircuitId")
                .withAsset("city","City")
                .withAsset("country","Country")
                .withAsset("displayCategory","DisplayCategory")
                .withAsset("division","Division")
                .withAsset("floor","Floor")
                .withAsset("latitude","10")
                .withAsset("longitude","10")
                .withAsset("managedObjectInstance","ManagedObjectInstance")
                .withAsset("managedObjectType","ManagedObjectType")
                .withAsset("manufacturer","Manufacturer")
                .withAsset("modelNumber","ModelNumber")
                .withAsset("notifyCategory","NotifyCategory")
                .withAsset("operatingSystem","OperatingSystem")
                .withAsset("pollerCategory","PollerCategory")
                .withAsset("port","Port")
                .withAsset("rack","Rack")
                .withAsset("region","Region")
                .withAsset("room","Room")
                .withAsset("slot","slot")
                .withAsset("state","State")
                .withAsset("thresholdCategory","ThresholdCategory")
                .withAsset("vendor","Vendor")
                .withAsset("zip","Zip")
                .getNode();
